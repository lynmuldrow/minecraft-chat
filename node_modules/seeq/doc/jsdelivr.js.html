...
<head>
	<meta charset="utf-8">
	<title>seeq Source: resource/module/cdn/jsdelivr.js</title>
...
<div class="container-fluid">
	...
	<div class="row-fluid">
		...
		<h1 class="page-title">Source: resource/module/cdn/jsdelivr.js</h1>
    
    <section>
        <article>
            <pre class="sunlight-highlight-javascript linenums">/**
 * Module that provides means to check/search in {@link http://www.jsdelivr.com/ jsDelivr}.
 * 
 * @module jsdelivr
 */
...
exports.detect = function(name, callback, settings) {
    cdn.detect(name, callback, mixing({cdn: "jsdelivr"}, settings));
};
</pre>
        </article>
    </section>
