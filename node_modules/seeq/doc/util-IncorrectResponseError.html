...
<head>
	<meta charset="utf-8">
	<title>seeq Class: IncorrectResponseError</title>
...
<div class="container-fluid">
	...
	<h1 class="page-title">Class: IncorrectResponseError</h1>
<section>

<header>
    <h2>
        <span class="ancestors"><a href="util_.html">resource/util</a>~</span>
...
<dt>
    <h4 class="name" id="IncorrectResponseError"><span class="type-signature"></span>new IncorrectResponseError<span class="signature">(responseData, <span class="optional">message</span>)</span><span class="type-signature"></span></h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last">Received response data.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="util.js_.html">resource/util.js</a>, <a href="util.js_.html#sunlight-1-line-164">line 164</a>
    </li></ul></dd>
